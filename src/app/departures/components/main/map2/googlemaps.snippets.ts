import { CustomMapOptions, CustomMapTypeStyle, CustomMarkerOptions } from '../models/googlemapscustom.interface'

export const customStylesSnippet = [
...
export const testStylesSnippet: google.maps.MapTypeStyle[] = [
  { elementType: 'geometry', stylers: [{ color: '#212121' }] },
  { elementType: 'labels.text.stroke', stylers: [{ color: '#212121' }] },
  { elementType: 'labels.text.fill', stylers: [{ color: '#757575' }] },
  { elementType: 'labels.icon', stylers: [{ visibility: 'off' }] },
